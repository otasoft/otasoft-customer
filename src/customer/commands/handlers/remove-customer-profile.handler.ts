...
export class RemoveCustomerProfileHandler implements ICommandHandler<RemoveCustomerProfileCommand> {
    constructor(
    ...
    async execute(command: RemoveCustomerProfileCommand) {
        ...
        try {
            ...
            throw new RpcException(`Problem occured when removing a customer profile: ${error}`)
        }
